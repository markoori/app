    ...
    function getCartItems(arg){
        ...
        for (const keys in cart_items[cart_items.length - 1][0]) {
           ...
           // div_data.appendChild(div_details.appendChild(div_details_h3,div_details_p));
            ...
            img_el.src = "../../public/img/img/img4.png"
            ...
            if(empty_checker(cart_items[cart_items.length - 1][0])){
                cart_table.innerHTML = "<h2 style='opacity: .3'>Sorry you cart is Empty, Add something to it 😊</h2>"
            }
            else{
...

{
    function submitForm(){
        ...
        // insert the updated price in reall storage
        cart[2] = update_price
